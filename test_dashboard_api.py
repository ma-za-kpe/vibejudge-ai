...
response = requests.get(f"{DASHBOARD_BASE}/hackathons", headers={"X-API-Key": API_KEY}, timeout=5)
...
response2 = requests.get(f"{CORRECT_BASE}/hackathons", headers={"X-API-Key": API_KEY}, timeout=5)
